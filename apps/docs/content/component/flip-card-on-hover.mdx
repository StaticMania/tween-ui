...
feature list, and a CTA staggering into place**. Driven by GSAP, and it fully
respects `prefers-reduced-motion`.

::component-preview{name="flip-card-on-hover" size="lg"}
::
...
::install-tabs{item="@tweenui/flip-card-on-hover"}
::

:::
:::tabs-item{label="Manual" icon="i-lucide-clipboard"}

::component-source{name="flip-card-on-hover"}
::
...
```tsx [app/page.tsx]
import FlipCardOnHover from '@/components/tweenui/card/flip-card-on-hover';
