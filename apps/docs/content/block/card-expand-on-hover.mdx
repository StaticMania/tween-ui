...
::component-preview{name="card-expand-on-hover" size="xl"}
::
...
::install-tabs{item="@tweenui/card-expand-on-hover"}
::

:::
:::tabs-item{label="Manual" icon="i-lucide-clipboard"}

::component-source{name="card-expand-on-hover"}
::
...
```tsx [app/page.tsx]
import CardExpandOnHover from '@/components/tweenui/card/card-expand-on-hover';
...
| ------- | ------------------------- | ------------- | ----------------- |
| `cards` | `CardExpandOnHoverItem[]` | 3-card sample | Cards in the row. |
