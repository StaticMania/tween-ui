...
keys. GSAP + SplitText, and it fully respects `prefers-reduced-motion`.

::component-preview{name="line-sweep" size="xl"}
::
...
::install-tabs{item="@tweenui/line-sweep"}
::

:::
:::tabs-item{label="Manual" icon="i-lucide-clipboard"}

::component-source{name="line-sweep"}
::
...
```tsx [app/page.tsx]
import LineSweep from '@/components/tweenui/line-sweep';
...
| `items`       | `LineSweepItem[]` | four quotes    | Quotes to page through, two at a time. |
