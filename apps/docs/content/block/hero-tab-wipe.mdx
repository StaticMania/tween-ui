...
between clicks. GSAP + CustomEase, and it fully respects
`prefers-reduced-motion`.

::component-preview{name="hero-tab-wipe" size="xl"}
::
...
::install-tabs{item="@tweenui/hero-tab-wipe"}
::

:::
:::tabs-item{label="Manual" icon="i-lucide-clipboard"}

::component-source{name="hero-tab-wipe"}
::
...
```tsx [app/page.tsx]
import HeroTabWipe from '@/components/tweenui/hero-tab-wipe';
...
| -------- | -------------------- | ----------- | ------------------------------------------ |
| `slides` | `HeroTabWipeSlide[]` | three shots | Stage slides; the tab strip mirrors these. |
