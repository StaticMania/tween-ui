...
::component-preview{name="testimonial-strip-wipe" size="xl"}
::
...
::install-tabs{item="@tweenui/testimonial-strip-wipe"}
::

:::
:::tabs-item{label="Manual" icon="i-lucide-clipboard"}

::component-source{name="testimonial-strip-wipe"}
::
...
```tsx [app/page.tsx]
import TestimonialStripWipe from '@/components/tweenui/testimonial/testimonial-strip-wipe';
...
export default function Page() {
  return <TestimonialStripWipe testimonials={testimonials} directional={false} />;
}
```
