...
export default function ScrollSpinImageDemo() {
  return (
    <div
      ...
      className="relative h-full w-full overflow-y-auto overscroll-contain rounded-xl border border-[#18181b]/10 bg-white"
    >
      <div className="relative flex min-h-[160vh] flex-col items-center px-4 pt-8 pb-24">
        <p className="mb-8 text-center text-xs text-[#18181b]/50">
        ...
        />
        <p className="mt-16 text-center text-xs text-[#18181b]/50">
